...
public class ContentCategoryController {
	...
	@ResponseBody
	public XuebusiResult createContentCategory(Long parentId, String name) {
		XuebusiResult result = contentCategoryService.insertContentCategory(parentId, name);
		return result;
	}
}
