...
<div class="w">
    <div id="logo">
    	<a href="http://hadoop01:8808" clstag="passport|keycount|login|01">
    		<img src="/images/xuebusi-logo.gif" alt="学步思" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "http://www.xuebusi.com";
						} else {
