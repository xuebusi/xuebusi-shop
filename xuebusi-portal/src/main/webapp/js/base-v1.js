 ...
 */
function login() {
    return location.href = "http://sso.xuebusi.com/page/login";
}
function regist() {
    return location.href = "http://sso.xuebusi.com/page/register";
}
...
function search(a) {
    var b = "http://hadoop01:8808/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
