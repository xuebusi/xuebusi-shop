...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://manage.xuebusi.com/web/itemcat/all?callback=category.getDataService",
		URL_Serv: "http://hadoop02:8080/rest/itemcat/list?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.xuebusi.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
